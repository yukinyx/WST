...
<style>
    ...
    .mobile-bottom-nav .nav-item.active i { color: #9c340bff; }
    ...
    @media (max-width: 767px) {
        /* Hide Top Info Bar, Menu Links, and Header Icons (Cart/Profile) */
        .header__top,
        .header__menu, 
        .header__cart { 
        ...
        /* Center the Logo since other elements are gone */
        .header__logo { 
            text-align: center; 
            margin-bottom: 0; 
            padding: 10px 0;
